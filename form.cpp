    ...
    : QWidget(parent), param(nullptr), t_cur_(0.0)
{
    ...
    layoutNxNt->addWidget(labelSizeX_1, 0, 0, 1, 1);
    layoutNxNt->addWidget(labelSizeX_2, 0, 1, 1, 1);
    layoutNxNt->addWidget(labelSizeX, 0, 2, 1, 1);
    layoutNxNt->addWidget(labelSizeT_1, 1, 0, 1, 1);
    layoutNxNt->addWidget(labelSizeT_2, 1, 1, 1, 1);
    layoutNxNt->addWidget(labelSizeT, 1, 2, 1, 1);
    layoutNxNt->addWidget(labelNX_1, 2, 0, 1, 1, Qt::AlignBaseline);
    layoutNxNt->addWidget(labelNX_2, 2, 1, 1, 1, Qt::AlignBaseline);
    layoutNxNt->addWidget(spinBoxNX, 2, 2, 1, 1);
    layoutNxNt->addWidget(sliderNX, 2, 3, 1, 1);
    layoutNxNt->addWidget(labelNT_1, 3, 0, 1, 1, Qt::AlignBaseline);
    layoutNxNt->addWidget(labelNT_2, 3, 1, 1, 1, Qt::AlignBaseline);
    layoutNxNt->addWidget(spinBoxNT, 3, 2, 1, 1);
    layoutNxNt->addWidget(sliderNT, 3, 3, 1, 1);
    layoutNxNt->addWidget(labelStepX_1, 4, 0, 1, 1);
    layoutNxNt->addWidget(labelStepX_2, 4, 1, 1, 1);
    layoutNxNt->addWidget(labelStepX, 4, 2, 1, 1);
    layoutNxNt->addWidget(labelStepT_1, 5, 0, 1, 1);
    layoutNxNt->addWidget(labelStepT_2, 5, 1, 1, 1);
    layoutNxNt->addWidget(labelStepT, 5, 2, 1, 1);
    layoutNxNt->addWidget(labelCFL_1, 6, 0, 1, 1);
    layoutNxNt->addWidget(labelCFL_2, 6, 1, 1, 1);
    layoutNxNt->addWidget(labelCFL, 6, 2, 1, 1);
    layoutNxNt->addWidget(pushButtonSolve, 5, 3, 2, 1);

    QVBoxLayout *layoutParam = new QVBoxLayout;
    layoutParam->addWidget(chartView);
    layoutParam->addWidget(comboBoxInitial);
    layoutParam->addLayout(layoutNxNt);
    layoutParam->addWidget(sliderNT);
